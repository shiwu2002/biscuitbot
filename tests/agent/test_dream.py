...
from xianaibot.utils.prompt_templates import render_template
...
class TestEphemeralDirect:
    ...
    def _make_loop(self, tmp_path):
        ...
        with (
            ...
            patch("xianaibot.agent.loop.SubagentManager") as mock_sub,
            patch("xianaibot.agent.loop.Consolidator") as mock_consolidator_cls,
        ):

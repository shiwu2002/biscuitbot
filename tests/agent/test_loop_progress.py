...
import hczkbot.agent.runner as runner_module
...
class TestToolEventProgress:
    ...
    async def test_streamed_progress_is_not_repeated_before_tool_execution(
        ...
        loop.provider.chat_stream_with_retry = chat_stream_with_retry  # type: ignore[method-assign]
    ...
    async def test_websocket_dispatch_publishes_turn_end_after_error(
        ...
        loop._process_message = raise_from_turn

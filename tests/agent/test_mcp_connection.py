...
from xianaibot.agent.tools import mcp as mcp_runtime
from xianaibot.agent.tools.base import Tool
from xianaibot.agent.tools.mcp import MCPResourceWrapper, MCPToolWrapper
...
async def test_connect_mcp_retries_when_no_servers_connect(tmp_path, monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("xianaibot.agent.tools.mcp.connect_mcp_servers", _fake_connect)

...
from hczkbot.agent.tools.web import WebFetchTool, _validate_url
...
def _patch_env():
    return patch("hczkbot.security.network.socket.getaddrinfo", _fake_resolve_public), \
           patch("hczkbot.agent.tools.web.httpx.AsyncClient", FakeClient)

...
from xianaibot.agent.tools.loader import _SKIP_MODULES, ToolLoader
...
def test_exec_tool_config_cls():
    from xianaibot.agent.tools.shell import ExecTool, ExecToolConfig
...
def test_web_tools_config_cls():
    from xianaibot.agent.tools.web import WebFetchTool, WebSearchTool, WebToolsConfig
...
def test_image_gen_tool_config_cls():
    from xianaibot.agent.tools.image_generation import ImageGenerationTool, ImageGenerationToolConfig
...
def test_my_tool_config_cls():
    from xianaibot.agent.tools.self import MyTool, MyToolConfig
    assert MyTool.config_key == "my"
    assert MyTool.config_cls() is MyToolConfig


def test_my_tool_enabled():
    from xianaibot.agent.tools.self import MyTool
    mock_config = MagicMock()
...
def test_mcp_wrappers_not_discoverable():
    from xianaibot.agent.tools.mcp import MCPPromptWrapper, MCPResourceWrapper, MCPToolWrapper

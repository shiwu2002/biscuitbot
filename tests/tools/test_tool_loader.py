...
from biscuitbot.agent.tools.loader import _SKIP_MODULES, ToolLoader
...
def test_web_tools_config_cls():
    from biscuitbot.agent.tools.web import WebFetchTool, WebSearchTool, WebToolsConfig
...
def test_image_gen_tool_config_cls():
    from biscuitbot.agent.tools.image_generation import ImageGenerationTool, ImageGenerationToolConfig
...
def test_my_tool_config_cls():
    from biscuitbot.agent.tools.self import MyTool, MyToolConfig
...
def test_mcp_wrappers_not_discoverable():
    from biscuitbot.agent.tools.mcp import MCPPromptWrapper, MCPResourceWrapper, MCPToolWrapper

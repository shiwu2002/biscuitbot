...
from hczkbot.agent.tools.loader import _SKIP_MODULES, ToolLoader
...
def test_web_tools_config_cls():
    from hczkbot.agent.tools.web import WebFetchTool, WebSearchTool, WebToolsConfig
...
def test_web_fetch_tool_create():
    from hczkbot.agent.tools.web import WebFetchTool
    mock_config = MagicMock()
    mock_config.web.enable = True
...
def test_image_gen_tool_config_cls():
    from hczkbot.agent.tools.image_generation import ImageGenerationTool, ImageGenerationToolConfig
...
def test_image_gen_tool_enabled():
    from hczkbot.agent.tools.image_generation import ImageGenerationTool
    mock_config = MagicMock()
...
def test_my_tool_config_cls():
    from hczkbot.agent.tools.self import MyTool, MyToolConfig
...
def test_mcp_wrappers_not_discoverable():
    from hczkbot.agent.tools.mcp import MCPPromptWrapper, MCPResourceWrapper, MCPToolWrapper

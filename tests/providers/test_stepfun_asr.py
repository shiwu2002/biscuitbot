...
from xianaibot.providers.transcription import StepFunTranscriptionProvider
...
def test_stepfun_in_registry() -> None:
    ...
    assert spec.adapter == "xianaibot.providers.transcription:StepFunTranscriptionProvider"

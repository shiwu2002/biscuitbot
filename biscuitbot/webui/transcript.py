...
from biscuitbot.webui.metadata import WEBUI_MESSAGE_SOURCE_METADATA_KEY, WEBUI_TURN_METADATA_KEY
...
def replay_transcript_to_ui_messages(
    ...
    *,
    ...
    Mirrors the core fold in ``useBiscuitbotStream.ts`` (delta, reasoning,

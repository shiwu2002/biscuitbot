...
| `xianaibot/__init__.py` | `_read_pyproject_version() or "0.2.2"` | 改为 `"0.2.3"`           |
...
- `dist/xianaibot-{版本}-py3-none-any.whl` — Wheel 包
- `dist/xianaibot-{版本}.tar.gz` — 源码包

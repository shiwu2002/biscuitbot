...
This module owns xianaibot's transcription behavior: config resolution,
...
HTTP details; those live in ``xianaibot.providers.transcription``.
"""
...
from xianaibot.utils.media_decode import FileSizeExceeded, save_base64_data_url
...
def _resolve_transcription_api_base(provider: str, provider_cfg: Any) -> str:
    ...
    if llm_api_base:
        from xianaibot.providers.image_generation import extract_domain

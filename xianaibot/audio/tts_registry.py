...
Provider-specific adapters live in ``xianaibot.providers.tts``.
...
TTS_PROVIDERS: tuple[TtsProviderSpec, ...] = (
    TtsProviderSpec(
        ...
        default_voice="alloy",
        adapter="xianaibot.providers.tts:OpenAITtsProvider",
    ...
    TtsProviderSpec(
        ...
        adapter="xianaibot.providers.tts:DashScopeTtsProvider",
    ...
    TtsProviderSpec(
        ...
        adapter="xianaibot.providers.tts:EdgeTtsProvider",

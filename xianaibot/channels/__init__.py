...
所属模块与项目作用
===================
本文件位于 xianaibot/channels 目录，是 Channel（聊天平台接入）层的包初始化组件。
...
from xianaibot.channels.base import BaseChannel  # 所有渠道实现的抽象基类
from xianaibot.channels.manager import ChannelManager  # 渠道生命周期与并发管理器

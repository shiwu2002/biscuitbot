...
from xianaibot.config.paths import get_webui_dir
from xianaibot.cron.session_turns import CRON_HISTORY_META
from xianaibot.session.manager import SessionManager
from xianaibot.webui.metadata import WEBUI_MESSAGE_SOURCE_METADATA_KEY, WEBUI_TURN_METADATA_KEY
...
def replay_transcript_to_ui_messages(
    ...
    *,
    ...
    Mirrors the core fold in ``useXianaibotStream.ts`` (delta, reasoning,

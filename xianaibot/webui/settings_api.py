...
from xianaibot.audio.transcription import resolve_transcription_config
from xianaibot.audio.transcription_registry import (
    get_transcription_provider,
    resolve_transcription_provider,
    transcription_provider_names,
)
from xianaibot.audio.tts import resolve_tts_config
from xianaibot.audio.tts_registry import (
    get_tts_provider,
    resolve_tts_provider,
    tts_provider_names,
)
from xianaibot.channels.deps import deps_status, ensure_channel_deps
from xianaibot.config.loader import get_config_path, load_config, update_config
from xianaibot.config.paths import get_workspace_path
from xianaibot.config.schema import ModelPresetConfig, ProviderConfig
...
from xianaibot.providers.registry import PROVIDERS, create_dynamic_spec, find_by_name
from xianaibot.security.workspace_access import workspace_sandbox_status
from xianaibot.utils.knowledge_index import delete_document, list_documents
from xianaibot.webui.token_usage import token_usage_payload
from xianaibot.webui.workspaces import (
...
def channels_payload() -> dict[str, Any]:
    ...
    复用 CLI ``channels_status``（xianaibot/cli/commands.py）的枚举方式：

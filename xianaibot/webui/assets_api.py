...
from xianaibot.webui.http_utils import query_first
...
def _stable_stage_tts(path: Path) -> Path:
    ...
    """
    from xianaibot.webui.media_api import stable_staged_path
...
def document_preview(query: QueryParams) -> dict[str, Any]:
    ...
    docx/pdf/xlsx/pptx/txt 经 ``xianaibot.utils.document.extract_text`` 提取

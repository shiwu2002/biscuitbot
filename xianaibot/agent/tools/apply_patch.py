...
所属模块与项目作用
===================
本文件位于 xianaibot/agent/tools 目录，是工具系统的文件编辑组件。
...
from xianaibot.agent.tools.base import tool_parameters  # 工具参数装饰器
from xianaibot.agent.tools.filesystem import _FsTool  # 文件系统工具基类
from xianaibot.agent.tools.schema import (  # JSON Schema 构造器
    ArraySchema,
    BooleanSchema,
    ObjectSchema,
    StringSchema,

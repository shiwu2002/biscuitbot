...
所属模块与项目作用
===================
本文件位于 xianaibot/agent/tools 目录，是工具系统中的"自省"组件。MyTool
...
from xianaibot.agent.tools.context import ContextAware, RequestContext  # 上下文感知 mixin 与请求上下文
from xianaibot.agent.tools.runtime_state import RuntimeState  # 运行时状态协议

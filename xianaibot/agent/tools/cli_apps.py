...
所属模块与项目作用
===================
本文件位于 xianaibot/agent/tools 目录，是工具系统的 CLI 应用执行组件。
...
from xianaibot.agent.tools.schema import ArraySchema, BooleanSchema, IntegerSchema, StringSchema, tool_parameters_schema  # Schema 构造器
from xianaibot.security.workspace_access import current_tool_workspace  # 工作区访问控制
from xianaibot.apps.cli import CliAppError, CliAppManager, CliAppsRuntimeConfig  # CLI 应用管理

...
所属模块与项目作用
===================
本文件位于 xianaibot/agent/tools 目录，是工具系统中的网络访问组件。提供
两个工具：
...
from xianaibot.utils.helpers import build_image_content_blocks  # 图片内容块构建
...
_VOLCENGINE_TRAFFIC_TAG = "xianaibot"  # 火山引擎流量标签

...
from xianaibot.agent.tools.file_state import FileStates, current_file_states
from xianaibot.agent.tools.path_utils import resolve_workspace_path
from xianaibot.agent.tools.schema import (
    BooleanSchema,
    IntegerSchema,
    StringSchema,
    tool_parameters_schema,
)
from xianaibot.config_base import Base
from xianaibot.security.workspace_access import current_tool_workspace
from xianaibot.security.workspace_policy import WorkspaceBoundaryError
from xianaibot.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from xianaibot.utils.document import extract_text

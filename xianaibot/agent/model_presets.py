...
所属模块与项目作用
===================
本文件位于 ``xianaibot/agent`` 目录，是 Agent 模块中负责运行时模型预设
...
from xianaibot.config.schema import ModelPresetConfig  # 模型预设配置类型
from xianaibot.providers.base import LLMProvider  # LLM 提供商基类
from xianaibot.providers.factory import ProviderSnapshot, build_provider_snapshot  # 提供商快照及其构建函数

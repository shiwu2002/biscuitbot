...
所属模块与项目作用
===================
本文件位于 xianaibot/providers 目录，是 LLM Provider 层的核心抽象组件。
在项目架构中起到的作用：
...
from xianaibot.utils.helpers import image_placeholder_text  # 图片占位文本生成

# 流式空闲超时的环境变量名
STREAM_IDLE_TIMEOUT_ENV = "XIANAIBOT_STREAM_IDLE_TIMEOUT_S"

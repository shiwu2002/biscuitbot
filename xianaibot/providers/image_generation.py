...
本模块在 xianaibot 项目中承担"多模态图像生成"职责：
...
产品层的配置兜底、WebUI 上传校验、频道集成等逻辑位于 ``xianaibot.audio`` 等模块，
...
from xianaibot.providers.registry import find_by_name  # 按 name 查找 Provider 元数据
from xianaibot.security.network import validate_url_target  # SSRF 防护校验
from xianaibot.utils.helpers import data_url, detect_image_mime  # data URL 构造 / MIME 识别

...
所属模块与项目作用
===================
本文件位于 xianaibot/providers 目录，是 LLM Provider 层的工厂组件。
在项目架构中起到的作用：
...
from xianaibot.config.schema import Config, InlineFallbackConfig, ModelPresetConfig
from xianaibot.providers.base import LLMProvider  # Provider 抽象基类
from xianaibot.providers.fallback_provider import FallbackProvider  # 失败转移包装器

# Provider 注册表：按名查找 spec / 创建动态 spec
from xianaibot.providers.registry import create_dynamic_spec, find_by_name

...
所属模块与项目作用
===================
本文件位于 xianaibot/utils 目录，是工具函数模块的包初始化文件。
在项目架构中起到的作用：
...
from xianaibot.utils.helpers import ensure_dir  # 目录创建工具
from xianaibot.utils.path import abbreviate_path  # 路径缩写工具
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "xianaibot.webui.thread_disk",
    "webui_transcript": "xianaibot.webui.transcript",
    "webui_turn_helpers": "xianaibot.session.webui_turns",
}

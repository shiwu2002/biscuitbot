...
所属模块与项目作用
===================
本文件位于 xianaibot/utils 目录，是工具函数模块的产物存储组件。
在项目架构中起到的作用：
...
from xianaibot.config.paths import get_workspace_path  # 获取工作区路径（生成资产跟随工作区落盘）
from xianaibot.utils.helpers import detect_image_mime, ensure_dir  # MIME 嗅探与建目录

...
所属模块与项目作用
===================
本文件位于 xianaibot/utils 目录，是工具函数模块的通知评估组件。
在项目架构中起到的作用：
...
from xianaibot.utils.prompt_templates import render_template  # 渲染提示词模板

if TYPE_CHECKING:
    from xianaibot.providers.base import LLMProvider  # 仅用于类型注解，避免循环导入

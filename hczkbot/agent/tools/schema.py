"""JSON Schema fragment types: all subclass :class:`~hczkbot.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~hczkbot.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~hczkbot.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~hczkbot.agent.tools.base.Schema`.
...
from hczkbot.agent.tools.base import Schema
